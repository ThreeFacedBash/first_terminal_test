...
describe('Testing a function that takes in sales data in various departments during a work week and..' , function(){
    it('returns the name of the most profitable department' , function(){
